<?php foreach($data->getData() as $item ):?>
            ...
            <li>
                <div class="raiders-wrap">
                    <h2>
                    <a href="<?php echo $this->createUrl('article/view',array('id'=>$item->article_id))?>"><?php echo $item->addendum->title;?></a>
                    <?php if($item->draft == 1):?>
                    
                     <span class="reveiw">( 草稿 )</span>
                ...
                ?>
                    ...
                    <div class="raiders-bottom">
                        ...
                        <a href="<?php echo $this->createUrl('article/update',array('id'=>$item->article_id))?>">编辑</a><i></i>
                        <a href="<?php echo $this->createUrl('article/delete',array('id'=>$item->article_id));?>">删除</a>
...
<?php endforeach;?>
<?php
$this->widget('application.widgets.PageToolbar' , array('pagination'=>$data->pagination, 'ajaxContainerId'=>'results-list','useAjax'=>true, 'route'=>'myarticle/companion'));
?>