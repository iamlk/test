<div id="travel">
	<div class="main-right">
        ...
        <?php
$this->widget('application.widgets.PageToolbar' , array('pagination'=>$data->pagination, 'ajaxContainerId'=>'travel','useAjax'=>true, 'route'=>'peopleshare/citypage'));
?>
        <div class="clear"></div>
    </div>
    </div>