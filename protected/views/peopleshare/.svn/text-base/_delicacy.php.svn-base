...
<div class="fr">
    ...
    <div class="product-des">
        <div class="fl">
            <a href="<?php echo $this->createUrl('delicacy/view',array('id'=>$item['object_id'],'cid'=>$city_id));?>"><img width="180" height="130" src="<?php echo '/thumb/180_130/'.$image[0];?>"></a>
            <p class="share-time"><?php echo date('Y-m-d H:i:s',$item['created']);?></p>
        </div>
        <div class="product-option-wrap">
            <ul class="product-option">
                <li class="first"><h3 class="share-tit"><a href="<?php echo $this->createUrl('delicacy/view',array('id'=>$item['object_id'],'cid'=>$city_id));?>"><?php echo $item['title']?></a></h3></li>
                
                <?php foreach(Dynamic::model()->getDelicacyDynamicInfo($item['object_id']) as $value):?>
