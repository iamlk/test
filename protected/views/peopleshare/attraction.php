<div id="attraction">
	<div class="main-right">
        ...
        <?php
$this->widget('application.widgets.PageToolbar' , array('pagination'=>$data->pagination, 'ajaxContainerId'=>'attraction','useAjax'=>true, 'route'=>'peopleshare/attractionpage'));
?>
        <div class="clear"></div>
    </div>
</div>