 <?php foreach(Dynamic::model()->getRestaurantReviewDynamicInfo($item['interfix_id']) as $value):?>
...
<li>
                ...
                <div class="talk-content">
                    ...
                    <p class="talk-user-info">
                        <a rel="@keke" target="_blank" href="<?php echo Dynamic::goUrl($item['customer_id'],'center');?>" class="talk-user-name"><?php echo Customer::model()->getUserNickName($item['customer_id']);?></a> 在 <a target="_blank" class="talk-link" href="<?php echo  $this->createUrl('restaurant/view',array('id'=>$item['interfix_id']));?>">“<?php echo  $value->addendum->title;?>”</a>进行了<?php echo Dynamic::model()->getDynamicAction($item['action']);?>。
                    </p>
                    <div class="msg-box">
