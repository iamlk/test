...
<div class="talk-box2">
		<ul class="talk-type">
			<li>
				<a href="<?php echo $this->createUrl('people/index',array('u_id'=>$this->uid));?>" class="current">最新动态</a>
			</li>
	  ...
	  <!-- 	<p id="loading-talk">正在加载……</p>-->
              <?php
$this->widget('application.widgets.PageToolbar' , array('pagination'=>$dynamic->pagination, 'ajaxContainerId'=>'dynamic','useAjax'=>true, 'route'=>'center/indexpage'));
?>
	</div>
    </div>	