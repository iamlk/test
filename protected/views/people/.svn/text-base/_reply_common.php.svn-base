<div class="reply-box">
	...
	<form action="<?php echo  $this->createUrl('news/reply',array('parent_review_id'=>$review_id,'object_type'=>$type,'object_id'=>$obj_id));?>" class="ajax-talk" method="get">
			...
			<?php foreach($hf as $f):?>
				<li>
					<div class="comment-user-pic">
						<a href="<?php echo Dynamic::goUrl($f['customer_id'],'center');?>">
							<img src="<?php echo '/thumb/48_48/'.Customer::model()->getUserHeaderImage($f['customer_id']);?>" alt="">
						</a>
					</div>
					...
					<a href="<?php echo $this->createUrl('center/deletemessage',array('id'=>$f[$key[0]],'type'=>$type));?>" class="reply-comment delete ajax-item">删除</a>
				</li>
			<?php endforeach;?>
		<?php endif;?> 
	</ul>
