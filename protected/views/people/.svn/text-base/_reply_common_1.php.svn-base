<div class="reply-box">
	<div class="comment-form">
		<form action="<?php echo  $this->createUrl('news/reply',array('parent_review_id'=>$review_id,'object_type'=>$this->actionGetReviewType($key[0]),'object_id'=>$obj_id));?>" method="get" class="ajax-talk">
