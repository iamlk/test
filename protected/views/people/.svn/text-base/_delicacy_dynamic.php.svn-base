	...
	<li>
		...
		<div class="talk-content">
			...
			<p class="talk-user-info">
				...
				<a target="_blank" class="talk-link" href="<?php echo  $this->createUrl('delicacy/view',array('id'=>$item['interfix_id']));?>">
					“<?php echo  $value->addendum->title;?>”
				</a>
			</p>
			<div class="media-box">
				<a class="photo-share" href="<?php echo  $this->createUrl('delicacy/view',array('id'=>$item['interfix_id']));?>">
                ...
                ?>
			<div class="msg-box">
			 <?php echo mb_substr($content, 0, 100).'......<a target="_blank" href="'.$this->createUrl("delicacy/view",array("id"=>$item["interfix_id"])).'" class="indent5">[详情]</a>'; ?>
			</div>
