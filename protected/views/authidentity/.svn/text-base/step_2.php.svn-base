...
<input type="hidden" value="<?php echo $this->auth_type;?>" name="auth_type"/>
       ...
       <div class="profession-status">
           <p class="status1">1.阅读并同意<?php echo $this->auth;?>协议内容</p>
        ...
        <div class="authenticate-wrap">
            ...
            <div class="safelist">
               ...
               <p class="account"><label>绑定手机号码：</label><span>暂未绑定</span></p>
                ...
                <div class="slidewrap">
                    <p class="account"><label>新手机号码：</label><input type="text" class="text" id="phonenum" name="phonenum"><a class="get-code" href="<?php echo $this->createUrl('authidentity/sendphonenums')?>">获取验证码</a></p>
                    <p class="account"><label>效验码：</label><input type="text" class="text" name="phonenumyzm"/></p>
                </div>
                    ...
                    <div class="picture">
                        ...
                        <div class="upload_image mt30">
                            <a class="btn_addPic" href="javascript:;">
                                ...
                                <input type="file" class="filePrew fileAuth"  data-remote="./savetempimage" name="pic" size="3" title="支持jpg、jpeg、gif、png格式，文件小于5M"  tabindex="3">
                            </a>
			...
			<?php if($this->auth_type == 2):?>
			<div class="safelist">
                <div class="slidewrap">
                    <p class="account"><label>导游证：</label></p>
                    <div class="picture">
                        <div class="preview">
                           
                        <?php if(!empty($auth['guide_image'])):?>
                            <img width="160" height="160" alt="" src="/thumb/108_72/<?php echo $auth['guide_image'];?>">
                           <?php else:?>
                            <img width="160" height="160" alt="" src="../images/common/de_picture.png">
                           <?php endif;?>
                            
							<input type="hidden" value="" name="pic_guide" class="realimage">
                        </div>
                        <div class="example">
                            <img width="124" height="126" src="../images/common/head_guidebook.png" alt="">
                            <p>示例</p>
                        </div>
                        <div class="upload_image mt30">
                            <a href="javascript:;" class="btn_addPic">
                                <span><em>+</em>添加图片</span>
                                <input type="file" tabindex="3" data-remote="./savetempimage" title="支持jpg、jpeg、gif、png格式，文件小于5M" size="3" name="pic" class="filePrew fileAuth">
                            </a>
                            <p>支持jpg, gif,png格式的图片，建议图片尺寸160*160，（小于5M） </p>
                        </div>
                    </div>
