	 <?php $image=explode(',',json_decode($item['img_url']));?>
		<div class="collection-list">
			...
			<?php if( $count==1 ):?>
				<li class="big-img">
					<a href="<?php echo  $this->createUrl('goods/index',array('id'=>Product::model()->getProductGoods_id($item['object_id'])));?>">
    ...
    <?php if(!SiteShare::checkIsShare($item['object_type'],$item['object_id'])):?>
				...
				<?php endif;?>
					...
					<a href="<?php echo $this->createUrl('product/fullinfo',array('id'=>$item['object_id']));?>" class="edit">引用</a>
				</span>
			</p>
