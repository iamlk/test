	 <?php $image=explode(',',json_decode($item['img_url'],true));?>
		<div class="collection-list" >
			...
			<?php foreach($image as $val):?>
			 <?php $count++;?>
			  <?php if( $count==1 ):?>
				<li class="big-img"><a href="<?php echo  $this->createUrl('Itinerary/view',array('id'=>$item['object_id']));?>"><img src="<?php echo '/thumb/233_184/'.$val;?>" alt="" width="233" height="184" ></a></li>
				
			   <?php else:?> 
               <?php if($count <=4):?> 
				<li><a href="<?php echo  $this->createUrl('Itinerary/view',array('id'=>$item['object_id']));?>"><img src="<?php echo '/thumb/74_74/'.$val;?>" alt="" width="74" height="74"></a></li>
				<?php endif;?>
				<?php endif;?>
			<?php endforeach;?>  
			...
			<?php if(!SiteShare::checkIsShare($item['object_type'],$item['object_id'])):?>
				...
				<a href="<?php echo $this->createUrl('Itinerary/view',array('id'=>$item['object_id']));?>" class="edit">引用</a>
				</span>
			</p>
