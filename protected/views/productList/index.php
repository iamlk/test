        ...
        <div class="pro-list">
            <div class="pro-scroll-wrap">
                ...
                <div class="pro-map-nav">
                    <ul>
                        <li class="select"><a href="javascript:;">我能做的</a><img src="/images/pro_nav_line.png" alt=""></li>
                        <li><a href="<?php echo $this->createUrl('propertyList/index',array('city'=>$_city));?>">度假公寓</a><img src="/images/pro_nav_line.png" alt=""></li>
                    </ul>
                </div>

            </div>
            <div class="pro-list-scroll">
                <?php echo $this->renderPartial('_filter',array('filterData'=>$filterData));?>
                <div class="filters-order" style="display: ;">
                   <?php if(false): /** 按推荐排列暂时取消*/  ?> <label class="more-filters"><span class="toggle">关闭更多过滤条件</span><em class="icon"></em></label>
                ...
                <script type="text/javascript">
                $(function(){
                		//$("#pro-list-wrap").load("<?php echo $this->createUrl('product/item',array('id'=>18)) ?>");
                	});
                </script>
            </div>
        </div>
