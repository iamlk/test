<div id="resuts-list-wrap">
	<div id="results-list" class="clearfix">
		...
		<?php
			$this->widget('application.widgets.PageToolbar' , array('pagination'=>$albumrewview->pagination, 'ajaxContainerId'=>'results-list','useAjax'=>true, 'route'=>'peoplealbum/imagereviewpage'));
		?>			
	</div>
</div>