...
<p class="talk-function">
	...
	<span>|</span>
	<a  class="comment ajax-item" href="<?php echo $this->createUrl('collect/it');?>?type=<?php echo $type;?>&id=<?php echo $item['interfix_id'];?>">
		收藏(<em><?php  echo SiteFavorite::model()->myCount($type,$item['interfix_id']); ?></em>)
	</a>
