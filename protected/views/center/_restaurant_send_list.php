<?php foreach(Dynamic::model()->getRestaurantReviewDynamicInfo($item['restaurant_id']) as $value):?>
	<li>
	    ...
	    <div class="talk-content">
		    ...
		    <div class="media-box">
            <?php $city_id = Food::model()->getDelicacyCityId($item['restaurant_id']);?>
				<p>我回复了餐厅<a href="<?php echo $this->createUrl('restaurant/view',array('id'=>$item['restaurant_id'],'cid'=>$city_id));?>">“<?php  echo  $value->addendum->title;?>”</a></p>
		    </div>
			...
			<?php $hf= RestaurantReview::model()->getRestaurantReviewHF($item['restaurant_review_id']);?>
             ...
             <?php $filed='restaurant_review_id'?>
