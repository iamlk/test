  <?php foreach(Dynamic::model()->getAttractionReviewDynamicInfo($item['attraction_id']) as $value):?>
   <li>
       ...
       <div class="talk-content">
           ...
           <div class="media-box">
           <?php $city_id = Food::model()->getDelicacyCityId($item['attraction_id']);?>
               <p>我回复了景点<a href="<?php echo $this->createUrl('attraction/view',array('id'=>$item['attraction_id'],'cid'=>$city_id));?>">“<?php echo  $value->addendum->name;?>”</a></p>
           </div>
           ...
           <div class="talk-info">
            ...
            <?php $hf= AttractionReview::model()->getAttractionReviewHF($item['attraction_review_id']);?>
             <?php $obj_id=$item['attraction_id'];?>
              <?php $filed='attraction_review_id'?>
