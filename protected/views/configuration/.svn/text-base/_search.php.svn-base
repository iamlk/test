...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'configuration_id'); ?>
		<?php echo $form->textField($model,'configuration_id',array('size'=>10,'maxlength'=>10)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'configuration_group_id'); ?>
		<?php echo $form->textField($model,'configuration_group_id',array('size'=>10,'maxlength'=>10)); ?>
	</div>
