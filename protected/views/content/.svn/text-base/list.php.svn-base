<div class="main-wrap help-city-list">
    	...
    	<div class="column city-list">
    		...
    		<ul class="clearfix">
             <?php foreach($data as $v): ?>
    			<li>
    				<a target="_blank" title="<?php echo $v['name']; ?>" href="<?php echo $this->createUrl('city/index',array('cid'=> $v['city_id'])); ?>">
    ...
    <div class="pager" style="float:right;" >
        <?php $this->widget('application.widgets.PageToolbar' , array('pagination'=>$dataProvider->pagination, 'route'=>'content/list'));?>
    </div>
