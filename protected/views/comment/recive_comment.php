                   ...
                   <table class="mycent-table">
                       ...
                       <tr>
                        ...
                        <?php endif;?>
                           ...
                           <td>买家：<a href="/people/index?u_id=<?php echo $value['customer_id'];?>" target="_blank"><?php echo Customer::model()->getUserNickName($value['customer_id']);?></a></td>
