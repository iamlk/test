...
<?php
$this->widget('application.widgets.PageToolbar' , array('pagination'=>$data->pagination, 'ajaxContainerId'=>'send_comment','useAjax'=>true, 'route'=>'comment/SellerSendCommentPage'));
?>
