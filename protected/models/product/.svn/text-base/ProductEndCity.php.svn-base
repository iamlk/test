...
/**
 * This is the model class for table "product_end_city".
 *
 * The followings are the available columns in table 'product_end_city':
 ...
 * @property City $city
 */
class ProductEndCity extends BaseActiveRecord
{
